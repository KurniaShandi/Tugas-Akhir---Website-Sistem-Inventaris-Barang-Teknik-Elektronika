            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <select name="idPetugas" class="form-control" required>
                        ...
                        ?>
                            <option value="0" selected disabled>Pilih Nama Ruangan</option>
                        <?php } ?>
                        <?php
                        ...
                        while ($petugas = mysqli_fetch_array($query)) {
                            if ($barang['idPetugas'] == $petugas['idPetugas']) {
                                echo '<option value="' . $petugas["idPetugas"] . '" selected>' . $petugas["nmRuangan"] . '</option>';
                            } else {
                                echo '<option value="' . $petugas['idPetugas'] . '">' . $petugas['nmRuangan'] . '</option>';
                            }
                        }
                        ?>
                    </select>
