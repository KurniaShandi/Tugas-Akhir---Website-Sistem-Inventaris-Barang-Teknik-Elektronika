    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover" id="table">
            ...
            <tbody>
                ...
                $sql = $koneksi->query("SELECT * FROM peminjaman INNER JOIN mahasiswa ON mahasiswa.nim=peminjaman.nim INNER JOIN barang ON peminjaman.kdBarang = barang.kdBarang WHERE statusPeminjaman='Sedang Diproses' AND barang.idPetugas = '$id_petugas'");
